...
// Section card with header, divider, optional save button
function Section({
...
// Bare input styled to match project's Input component appearance
function Field({
  ...
  const integrations = [
    {
      ...
      description: 'Clicks, impressions, CTR, keyword positions',
      icon: <Search size={18} />,
      key: 'GSC',
    },
    {
      name: 'Google Analytics 4',
      description: 'Traffic, sessions, conversions, user behavior',
      icon: <BarChart2 size={18} />,
      key: 'GA4',
    },
    {
      name: 'WordPress',
      description: 'Auto-publish approved articles to your blog',
      icon: <Code size={18} />,
      key: 'WordPress',
    },
    {
      name: 'Webflow',
      description: 'Publish content directly to Webflow CMS',
      icon: <Layout size={18} />,
      key: 'Webflow',
    },
  ]
  ...
  return (
    <PageWrapper title={copy.settings.pageTitle} subtitle="Manage your account, agent preferences, and billing.">
      <div style={{ maxWidth: '640px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
        ...
        {/* ── 2. Profile ── */}
        <Section
          title={copy.settings.sections.profile}
          icon={<User size={16} />}
          saveLabel="Save profile"
          onSave={() => console.log('profile saved', profile)}
        >
        ...
        <Section title={copy.settings.sections.sites} icon={<Globe size={16} />}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <button
              onClick={() => console.log('disconnect site')}
              style={{
                fontSize: '12px',
                color: 'var(--text-secondary)',
          ...
          <button
            ...
            style={{
              ...
              color: 'var(--accent)',
              background: 'transparent',
              border: '0.5px dashed var(--accent-muted)',
              borderRadius: '8px',
              cursor: 'pointer',
            }}
          >
        ...
        <Section
          ...
          onSave={() => console.log('notifications saved', notifications)}
        >
          {notificationItems.map((item, i) => (
            <div
              ...
              style={{
                ...
                padding: '11px 0',
                borderBottom: i < notificationItems.length - 1 ? '0.5px solid rgba(255,255,255,0.4)' : undefined,
              }}
            >
              <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <Section title={copy.settings.sections.billing} icon={<CreditCard size={16} />}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '20px' }}>
            <div>
              ...
              <p style={{ fontSize: '14px', color: 'var(--text-secondary)', marginTop: '2px' }}>
                {growthPlan.currency}{growthPlan.price.toLocaleString('en-IN')} / month
              </p>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              ...
              <Button size="sm" variant="secondary" onClick={() => console.log('manage billing')}>
                Manage billing
              </Button>
            </div>
          </div>
          ...
          <p style={{ fontSize: '13px', color: 'var(--text-secondary)' }}>
            ...
            <button
              ...
              style={{ color: 'var(--accent)', background: 'none', border: 'none', cursor: 'pointer', fontSize: '13px', padding: 0 }}
            >
              View plans
            </button>
